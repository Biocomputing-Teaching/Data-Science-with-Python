...
\begin{frame}{Tradeoff vs risk}
  ...
  \begin{itemize}
    \item We seek within $\mathcal{G}$ the best approximation to the true pdf $f$, and we will call it $g(\bm{x})$. 
    \item Such best approaximation will minimize some calculated risk.
\end{frame}

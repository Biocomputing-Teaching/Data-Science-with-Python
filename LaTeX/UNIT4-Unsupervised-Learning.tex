...
\begin{frame}{HCA flavours}
    Different types of HCA can be done, depending on the way the distance between points (typically the Euclidean distance) and between clusters $I$ and $J$ (how the clusters are linked: {\em linkage criterion}) is computed:
    \begin{itemize}

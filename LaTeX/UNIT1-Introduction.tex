...
\title[Vectors]{Sistemes de coordenades i espais vectorials: introducció als vectors} % The short title appears at the bottom of every slide, the full title is only on the title page
...
%------------------------------------------------
\section{Els nombres reals} % Sections can be created in order to organize your presentation into discrete blocks, all sections and subsections are automatically printed in the table of contents as an overview of the talk
%------------------------------------------------
